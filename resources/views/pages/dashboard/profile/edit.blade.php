...
@section('content')
    @include('pages.dashboard.users.partials.header', [
        'title' => __('Welcome') . ' '. auth()->user()->first_name,
        'description' => __('This is your profile page. You can see the progress you\'ve made with your work and manage your projects or assigned tasks. More features are coming soon!'),
        'class' => 'col-lg-7'
    ])
                        ...
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img width="400"
                                         height="180"
                                         src="{{ asset('/images/profile_images') }}/{{auth()->user()->image }}"
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                ...
                                since {{ \Carbon\Carbon::parse(auth()->user()->date_created)->format('d/m/Y') }}
                            </div>
                            <div class="h5 mt-2">
                                <i class="ni business_briefcase-24 mr-2"></i> <small>Known
                                    as</small> {{ Str::title(auth()->user()->username) }}
                            </div>
                            <br>
                            <form method="POST" enctype="multipart/form-data" id="upload-image"
                                ...
                                <div class="row">
                                    ...
                                    <br><br>
                                    <div class="col-md-12">
                                        <input type="submit" class="btn btn-success" id="submit" value="Upload Photo"/>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('firstName') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="firstName" id="input-name"
                                           ...
                                           value="{{ old('firstName', auth()->user()->first_name) }}" disabled
                                           autofocus>
                                    <br>
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group{{ $errors->has('lastName') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="lastName" id="input-last-name"
                                           ...
                                           value="{{ old('lastName', auth()->user()->last_name) }}" disabled autofocus>
                                    <br>
